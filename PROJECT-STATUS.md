...
306 automated tests pass, plus 7 C++ test groups and an end-to-end simulated
...
`pytest` — **306 passed**, no cluster, no credentials, no network.
...
| `unit/test_credentials.py` | 59 | Primary-first chains, root fallback, ssh-failure classification, KRB5CCNAME, collection caches, host keys, cleanup |
